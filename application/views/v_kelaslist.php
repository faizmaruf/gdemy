    ...
    <section>
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-md-12 m-5 p-5 box-definisi">
                                ...
                                <div class="card-img-top ">
                                    <div class="row p-3">
                                        <div class="col-xl-4 d-flex justify-content-center">
                                            <img width="100px" src="<?php echo base_url() . 'assets/images/interaktif.png' ?>" alt="alternatif"
                                                class="mb-3">
                                        </div>
                        ...
                        <div class="card-1 card-border mb-4 shadow-sm bg-white shadow-lg">
                            <div class="card-header bg-white">
                                <div class="card-img-top ">
                                    <div class="row p-3">
                                        <div class="col-xl-4 d-flex justify-content-center">
                                            <img width="100px" src="<?php echo base_url() . 'assets/images/excel.png' ?>" alt="alternatif"
                                                class="mb-3">
                                        </div>
                                        <div class="col-xl-7 d-flex justify-content-center">
                                            <p>Pembelajaran Interaktif</p>
