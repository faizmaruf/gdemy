...
<body>
    ...
    <section class="bg-form">
        <form class="form-signin" action="<?php echo base_url() . 'Signin/ceklogin' ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="email" id="inputEmail" name="xemail" class="form-control mb-3" placeholder="Email address" required autofocus>
            <label for="inputPassword" class="sr-only">Password</label>
            <input type="password" id="inputPassword" name="xpassword" class="form-control mb-3" placeholder="Password" required>
